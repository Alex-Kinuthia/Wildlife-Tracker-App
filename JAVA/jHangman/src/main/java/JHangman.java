...
// Instance Variables
	...
	// gathering the user's input and parsing it
...
// end of output error messages to the user
 ...
 public static void main(String... args) {
	 ...
	 while(myInstance.getStatus() != "Congratulations you won" & myInstance.getStatus() != "game over") {
		 try {
			 ...
			 // catches errors in the statup
			 //catches errors on submissions
	 ...
	 // the final output when the game is over
